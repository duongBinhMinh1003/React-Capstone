...
const Header = () => {
  ...
  return (
    <header className="shadow-lg shadow-black fixed w-full top-0 left-0 z-50 bg-white">
      <nav
        className="mx-auto flex max-w-7xl items-center justify-between p-3 lg:px-8 content_nav"
        aria-label="Global"
      >
        {/* logo */}
        <div>
          <a href="#" className="-m-1.5 p-1.5">
          <span className="text-2xl font-medium text-red-400">CyberMovie</span>
          </a>
        </div>
